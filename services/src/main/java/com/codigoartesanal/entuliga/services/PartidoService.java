...
public interface PartidoService {
    ...
    public static final String PROPERTY_VISITANTE_ID        = "visitanteId";
    public static final String PROPERTY_VISITANTE_NOMBRE    = "visitanteNombre";
    public static final String PROPERTY_VISITANTE_PUNTOS    = "visitantePuntos";
