...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String username)
        ...
        com.codigoartesanal.entuliga.model.User user = userRepository.findByUsername(username);
    ...
    private User buildUserForAuthentication(com.codigoartesanal.entuliga.model.User user,
                                            List<GrantedAuthority> authorities) {
