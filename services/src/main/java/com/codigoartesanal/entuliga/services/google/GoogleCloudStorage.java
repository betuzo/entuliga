package com.codigoartesanal.entuliga.services.google;//[START all]
/*
...
public class GoogleCloudStorage {
   ...
   */
  private static final String APPLICATION_NAME = "entuliga";

  /** Global instance of the JSON factory. */
  private static final JsonFactory JSON_FACTORY = JacksonFactory.getDefaultInstance();
  private static final String TEST_FILENAME = "photo/equipo/json-test.txt";
