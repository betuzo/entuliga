...
public class TorneoJugador {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="torneojugador_id_seq")
    @SequenceGenerator(name="torneojugador_id_seq", sequenceName="torneojugador_id_seq")
    private Long id;
    @ManyToOne
